let classifier,video,label = 'waiting';

let pointsComputer = 0,pointsPlayer = 0;

let counter = 0,currentMove = '',computerMove = '';
...
function preload() {
  classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/jYMGNUhoh/model.json');
}
